...
public class ExibeTopicoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Topico t = tc.recuperar(id_topico);
            request.getSession().setAttribute("topicoSelecionado", t);
            ComentarioController cc = new ComentarioController();
            request.getSession().setAttribute("comentarios", cc.listaComentarios(id_topico));
